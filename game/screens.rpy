...
style navigation_button:
    ...
    activate_sound "sound/start.wav"     #sound when pressed    #################### 导航菜单的button音效 #################################################################################################################
    hover_sound "sound/move.wav"     #sound when hovered   ################ 适用于 hover，action都是短音效的场合 ###################################################################################################
...
style confirm_button:
    ...
    activate_sound "sound/start.wav"
    hover_sound "sound/move.wav"
...
define config.mouse = {'default' :[('mouse.png', 0, 0)],'mousedown' :[('mouse2.png', 0, 0)]}
...
transform transform_blink:
    ...
    repeat
screen ccc():
    on "show" action Notify("系统提示:已解锁画廊新图片")
