...
define gui.accent_color = '#72b2f1'

## 当既未选中也未悬停时用于文本按钮的颜色。
define gui.idle_color = '#B0B0B0'
...
## 用于角色名称的字体。
define gui.name_text_font = "Font.ttf"

## 用于游戏外文本的字体。
define gui.interface_text_font = "cn.ttf"
...
style default:
    outlines [ (absolute(1), "#1c222a", absolute(0), absolute(0)) ]
## 标题和游戏菜单 #####################################################################
