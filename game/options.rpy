...
人物模型基于Kumakuma Editor制作。

UI及界面所有菜单背景图基于PS制作。

场景图及音效源于网络,画廊部分插画基于真实照片后期合成。
...
define build.name = "cryptography"
...
define config.main_menu_music = "audio/因为我们在一起.mp3"
...
define config.save_directory = "cryptography-1584433385"
